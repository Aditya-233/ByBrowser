...
[![Binary Size](https://img.shields.io/badge/binary--size-561_KB-blueviolet.svg?style=flat-square)](#)
...
- 📦 **Single Standalone Native Binary:** 100% Rust with no external daemon, Python, or shell script dependencies.
